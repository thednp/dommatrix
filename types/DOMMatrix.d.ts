 ...
 */
declare function RotateAxisAngle(x: number, y: number, z: number, angle: number): CSSMatrix;
/**
 ...
 */
declare function fromMatrix(m: any): CSSMatrix;
/**
 ...
 */
declare function fromArray(a: any): CSSMatrix;
/**
 ...
 * @return {CSSMatrix} a The source array to feed values from.
 */
declare function feedFromArray(m: any, array: any[]): CSSMatrix;
